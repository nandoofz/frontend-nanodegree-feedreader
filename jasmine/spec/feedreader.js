...
$(function () {
    ...
    */
    ...
    describe('Initial Entries', function () {
         ...
         */
        it('when loadFeed() is called should have at least a single .entry element within the .feed container', function (done) {
    ...
    describe('New Feed Selection', function () {
        ...
        beforeEach(function (done) {
            callLoadFeed(0, done, callLoadFeed(1, done));
        });
         ...
         */
        it('when a new feed is loaded by the loadFeed() the content should actually change', function (done) {
    ...
    function callLoadFeed(id, done, cb) {
